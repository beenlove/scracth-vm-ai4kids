...
const Scratch3ClassificationQuestionsBlocks = require('../../src/extensions/scratch3_classificationquestions/index.js');
...
test('pen', t => {
    ...
    vm.on('playgroundData', () => {
        ...
        /** @type {PenState} */
        const originalPenState = originalCat.getCustomState(Scratch3ClassificationQuestionsBlocks.STATE_KEY);

        /** @type {PenState} */
        const clonePenState = cloneCat.getCustomState(Scratch3ClassificationQuestionsBlocks.STATE_KEY);
